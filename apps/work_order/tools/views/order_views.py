...
from ..serializers.serializers_order import WorkOrderSerializer, WorkOrderListSerializer
### Erencias
...
class WorkOrderViewset(viewsets.GenericViewSet):
    ...
    serializer_class = WorkOrderSerializer  ### Serializer
    ...
    def create(self, request):
        ...
        try:
            ...
            if serializer.is_valid():
                ...
                data["msg"] = "Se ha registrado el producto exitosamente."
                data["type"] = "success"
            else:
    ...
    def list(self, request, *args, **kwargs):
        ...
        try:
            queryset = self.queryset.filter(is_active=True, state=state)
    ...
    def retrieve(self, request, pk=None):
        ...
        try:
            ...
            if obj:
                user_serializer = WorkOrderListSerializer(obj)
                data["type"] = "success"
