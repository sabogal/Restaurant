    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.PositiveBigIntegerField(blank=True, null=True, unique=True, verbose_name='Documento')),
                ('number_phone', models.PositiveBigIntegerField(blank=True, null=True, verbose_name='Telefono')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token', models.UUIDField(blank=True, editable=False, null=True, verbose_name='Token')),
                ('last_name', models.CharField(blank=True, max_length=255, null=True, verbose_name='Apellidos')),
                ('document', models.PositiveBigIntegerField(blank=True, db_index=True, null=True, verbose_name='Documento')),
                ('number_phone', models.PositiveBigIntegerField(blank=True, null=True, verbose_name='Telefono')),
                ('is_active', models.BooleanField(default=False, verbose_name='Estado')),
                ('is_staff', models.BooleanField(default=False)),
